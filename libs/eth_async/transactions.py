...
class Transactions:
        ...
        try:
            ...
            try:
                ...
                raise AttributeError(
                    f'{e}:{tx_params["gas"]} probably got wrong response (need "gas" key in tx_params)')

            return tx_params

        except AttributeError as e:
            raise AttributeError(f'{e}:{tx_params["gas"]} probably got wrong response (need "gas" key in tx_params)')
    ...
    async def find_txs(
        ...
        try:
            ...
            # print(f'{e}, {coin_txs}')
            raise AttributeError(f'{e}, {coin_txs}')
